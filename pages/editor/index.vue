    ...
    <div class="flex flex-row gap-2">
      <div class="border-2 w-[70%] ">
        ...
        <div class="flex justify-start flex-row gap-2 mb-4 text-gray-700 items-start">
          <div class="w-[65%]">
            <p class="text-xl font-medium">Meta Title</p>
            <input
              class="w-full h-10 border border-gray-500 focus:outline-none tracking-normal rounded-md px-3 py-2 font-medium text-xl"
              type="text"
            />
        ...
        <div class="flex justify-start flex-col mb-4 text-gray-700 items-start">
          <p class="text-xl font-medium">Meta Description</p>
          <textarea
            class="w-full  h-10 border border-gray-500 focus:outline-none tracking-normal rounded-md px-3 py-2 font-medium text-lg"
            rows="2"
          />
        </div>
      </div>
      <div
        class="border-4 p-2 mb-3 rounded-lg border-dashed border-gray-500 bg-slate-200 w-[30%]"
      >
      <Toast />
        <FileUpload name="demo[]" url="/api/upload" @upload="onAdvancedUpload($event)" :multiple="false" accept="image/*" :maxFileSize="1000000">
          <template #empty>
                <div class="flex items-center justify-center flex-col">
                    <Icon name="material-symbols:water-drop-outline" class="w-28 text-gray-400 h-28"/>
                    <p class="text-gray-400">Drag and drop files to here to upload.</p>
                </div>
            </template>
        </FileUpload>
    </div>
    ...
    >
      ...
      >
        ...
        >
          <path
            fill="currentColor"
            d="M3 14q-.425 0-.712-.288T2 13q0-.425.288-.712T3 12h18q.425 0 .713.288T22 13q0 .425-.288.713T21 14zm7.5-4V7h-4q-.625 0-1.062-.437T5 5.5q0-.625.438-1.062T6.5 4h11q.625 0 1.063.438T19 5.5q0 .625-.437 1.063T17.5 7h-4v3zm0 6h3v2.5q0 .625-.437 1.063T12 20q-.625 0-1.062-.437T10.5 18.5z"
          />
        </svg>
      </button>
      <!--Code Button-->
      ...
      <button @click="editor.chain().focus().unsetAllMarks().run()">
        ...
        >
          <path
            fill="currentColor"
            d="M4 17q-.425 0-.712-.288T3 16q0-.425.288-.712T4 15h12q.425 0 .713.288T17 16q0 .425-.288.713T16 17zm2-4q-.425 0-.712-.288T5 12q0-.425.288-.712T6 11h12q.425 0 .713.288T19 12q0 .425-.288.713T18 13zm2-4q-.425 0-.712-.288T7 8q0-.425.288-.712T8 7h12q.425 0 .713.288T21 8q0 .425-.288.713T20 9z"
          />
        </svg>
      </button>
      <!--Clear Nodes Button-->
      ...
      >
        ...
        >
          <path
            fill="currentColor"
            d="M10 20q-.425 0-.712-.288T9 19v-5q-2.075 0-3.537-1.463T4 9q0-2.075 1.463-3.537T9 4h8q.425 0 .713.288T18 5q0 .425-.288.713T17 6h-1v13q0 .425-.288.713T15 20q-.425 0-.712-.288T14 19V6h-3v13q0 .425-.288.713T10 20"
          />
        </svg>
      </button>
      <!--Headings-->
      ...
      <button @click="editor.chain().focus().setHorizontalRule().run()">
        ...
        >
          <path
            fill="currentColor"
            d="M5 13q-.425 0-.712-.288T4 12q0-.425.288-.712T5 11h14q.425 0 .713.288T20 12q0 .425-.288.713T19 13z"
          />
        </svg>
      </button>
      <button @click="editor.chain().focus().setHardBreak().run()">
        ...
        >
          <path
            fill="currentColor"
            d="M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h14q.825 0 1.413.588T21 5v14q0 .825-.587 1.413T19 21zm4.5-10.7q.375 0 .75.15t.675.45l2.575 2.575L19 7.3V5H5v9l3.075-3.1q.3-.3.663-.45t.762-.15m3.925 5.25q-.375 0-.75-.137T12 14.975l-2.5-2.5L5 17v2h14v-8.7l-4.1 4.6q-.3.35-.675.5t-.8.15"
          />
        </svg>
      </button>
      <button
      ...
      >
        ...
        >
          <path
            fill="currentColor"
            d="M16.2 10H9.9q-1.575 0-2.738 1T6 13.5Q6 15 7.163 16T9.9 17H16q.425 0 .713.288T17 18q0 .425-.288.713T16 19H9.9q-2.425 0-4.163-1.575T4 13.5q0-2.35 1.738-3.925T9.9 8h6.3l-1.9-1.9q-.275-.275-.275-.7t.275-.7q.275-.275.7-.275t.7.275l3.6 3.6q.15.15.213.325t.062.375q0 .2-.062.375T19.3 9.7l-3.6 3.6q-.275.275-.7.275t-.7-.275q-.275-.275-.275-.7t.275-.7z"
          />
        </svg>
      </button>
    </div>
