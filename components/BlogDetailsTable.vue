<template>
  ...
  <div class="mt-8">
    <div class="mt-6">
      ...
      <!--Table Data-->
      <div class="mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
            ...
            <tbody>
              <tr v-for="(blog, index) in Blogs" :key="index">
                ...
                <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                  <!--Edit Button-->
                  <button class="mx-1">
                    <Icon @click="handleEdit(blog._id)" name="material-symbols:edit-square-outline-rounded" class="w-6 h-6 text-teal-600"/>
                  </button>
                  <!--Delete Button-->
...
//get all the data from the api/post
const Blogs = ref([]);
//get all the data from the api/post
onMounted(async()=>{
try {
